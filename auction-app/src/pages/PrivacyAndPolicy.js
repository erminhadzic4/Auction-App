  ...
  return (
    <div style={divPlaceholderStyle}>
      ...
      <p>
        ...
        shared and/or collect in auctionapp. This policy is not applicable to
      ...
      <p>
        auctionapp follows a standard procedure of using log files. These files
      ...
      <p>
        Like any other website, auctionapp uses "cookies". These cookies are
      ...
      <p>
        ...
        advertising partners of auctionapp.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on auctionapp, which are sent
      ...
      <p>
        Note that auctionapp has no access to or control over these cookies that
      ...
      <p>
        auctionapp's Privacy Policy does not apply to other advertisers or
