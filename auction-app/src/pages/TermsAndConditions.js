  ...
  return (
    <div className="div-placeholder-style">
      ...
      <p>
        ...
        shall manage your use of our website, auctionapp accessible at
        auctionapp@website.com.
      </p>
      ...
      <p>
        Other than the content you own, under these Terms, AuctionApp and/or its
      ...
      <p>
        ...
        and AuctionApp may further restrict access by you to any areas of this
      ...
      <p>
        ...
        AuctionApp a non-exclusive, worldwide irrevocable, sub licensable
      ...
      <p>
        ...
        rights. AuctionApp reserves the right to remove any of Your Content from
      ...
      <p>
        This Website is provided "as is," with all faults, and AuctionApp
      ...
      <p>
        In no event shall AuctionApp, nor any of its officers, directors and
        ...
        under contract.  AuctionApp, including its officers, directors and
      ...
      <p>
        You hereby indemnify to the fullest extent AuctionApp from and against
      ...
      <p>
        AuctionApp is permitted to revise these Terms at any time as it sees
      ...
      <p>
        The AuctionApp is allowed to assign, transfer, and subcontract its
      ...
      <p>
        These Terms constitute the entire agreement between AuctionApp and you
